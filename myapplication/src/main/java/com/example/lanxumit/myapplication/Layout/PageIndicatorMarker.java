...
package com.example.lanxumit.myapplication.Layout;
...
import com.example.lanxumit.myapplication.R;
...
public class PageIndicatorMarker extends FrameLayout {
    ...
    public void activate(boolean immediate) {
        if (immediate) {
    ...
    public void inactivate(boolean immediate) {
        if (immediate) {
            mInactiveMarker.animate().cancel();
