...
public final class CookieSyncManager extends WebSyncManager {
     ...
     * @return CookieSyncManager
     */
    public static synchronized android.webkit.CookieSyncManager createInstance(Context context) {
        if (context == null) {
     ...
     * @deprecated Use {@link android.webkit.CookieManager#flush} instead.
     */
    @Deprecated
    public void sync() {
