...
public abstract class WebMessagePort {
     ...
     *  {@link android.webkit.WebMessagePort#setWebMessageCallback(WebMessageCallback, Handler)}.
    ...
    public static abstract class WebMessageCallback {
         ...
         */
        public void onMessage(android.webkit.WebMessagePort port, WebMessage message) { }
    }
